...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🃏 Mʏ Gʀᴏᴜᴘ • Jᴏɪɴ Fᴀsᴛ 🃏', url=f'http://t.me/DCENIMAS_HD')
        ], [
                    
            InlineKeyboardButton('📝 H ᴇ ʟ ᴘ 📝', callback_data='rendering_info'),
            InlineKeyboardButton('🗽 A ʙ ᴏ ᴜ ᴛ 🗽', callback_data='help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
