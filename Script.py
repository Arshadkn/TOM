...
ʜᴇʀᴇ ɪꜱ ᴛʜᴇ ʜᴇʟᴩ ꜰᴏʀ ᴍy ᴄᴏᴍᴍᴀɴᴅꜱ.</b>"""
    ...
    STARTER_TXT = """
<i>👋Hello {} ഞാൻ ഒരു 𝐆𝐑𝐎𝐔𝐏 𝐌𝐀𝐍𝐀𝐆𝐈𝐍𝐆 𝐁𝐎𝐓 ആണ്, എന്നെ നിങ്ങളുടെ ഗ്രൂപ്പിൽ ആഡ് ചെയ്യാൻ നോക്കി സമയം കളയണ്ട, എന്നെ 𝑫𝑪𝑬𝑵𝑰𝑴𝑨𝑺 ഗ്രൂപ്പിൽ മാത്രമേ ആഡ് ചെയ്യാൻ കഴിയൂ...!!! </i>
...
𝑺𝒐𝒓𝒓𝒚 𝑩𝒓𝒐𝒐 𝑰𝒂𝒎 𝑶𝒏𝒍𝒚 𝑾𝒐𝒓𝒌𝒊𝒏𝒈 𝑭𝒐𝒓 𝑴𝒚 𝑶𝒘𝒏𝒆𝒓 🍒"""
    SETTING_TXT = """    
<b>ѕeттιngѕ
